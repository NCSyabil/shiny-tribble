// Replace legacy path aliases with direct relative import to consolidated globals
import { vars, webFixture, logFixture } from "../../global";
import { warn } from "winston";
import * as crypto from '../util/utilities/cryptoUtil';
// Local lightweight runner type helpers (previously from project config)
...
// Allure compatibility shim to avoid crashes when reporter doesn't expose step/attachment
